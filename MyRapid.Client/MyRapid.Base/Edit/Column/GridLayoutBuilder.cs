...
{
    public class GridLayoutBuilder : ComponentDesigner
    {
        private IContainer components;
        [DebuggerNonUserCode]
        public GridLayoutBuilder(IContainer container) : this()
        {
        ...
        public GridLayoutBuilder()
        {
            ...
            DesignerVerb value = new DesignerVerb("加载字段", delegate (object a0, EventArgs a1)
            {
                this.BuildClick();
            });
        ...
        public override void DoDefaultAction()
        {
            ...
            GridLayoutBuilderUI myBuildFrm = new GridLayoutBuilderUI(designerHost);
