...
{
    public class MyXtraSpreadsheetResLocalizer: XtraSpreadsheetResLocalizer
    {
        public override string GetLocalizedString(XtraSpreadsheetStringId ID)
        {
            return BaseLocalizer.GetLocalizedString<XtraSpreadsheetStringId>((int)ID, base.GetLocalizedString(ID), base.GetType().Name);
            //string enumName = Enum.GetName(typeof(XtraSpreadsheetStringId), ID);
