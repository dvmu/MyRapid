...
namespace MyRapid.GlobalLocalizer
{
    public class MyPreviewLocalizer: PreviewLocalizer
    {
        ...
        {
            return BaseLocalizer.GetLocalizedString<PreviewStringId>((int)ID, base.GetLocalizedString(ID), base.GetType().Name);
            //string enumName = Enum.GetName(typeof(PreviewStringId), ID);
