...
namespace MyRapid.GlobalLocalizer
{
    public class MyReportLocalizer: ReportLocalizer
    {
        ...
        {
            return BaseLocalizer.GetLocalizedString<ReportStringId>((int)ID, base.GetLocalizedString(ID), base.GetType().Name);
            //string enumName = Enum.GetName(typeof(ReportStringId), ID);
