...
{
    public class MyNavBarLocalizer: NavBarLocalizer
    {
        public override string GetLocalizedString(NavBarStringId ID)
        {
            return BaseLocalizer.GetLocalizedString<NavBarStringId>((int)ID, base.GetLocalizedString(ID), base.GetType().Name);
            //string enumName = Enum.GetName(typeof(NavBarStringId), ID);
