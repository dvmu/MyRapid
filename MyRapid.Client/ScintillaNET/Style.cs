...
namespace ScintillaNET
{
    ...
    public class Style
    {
        ...
        public static class MSSql
        {
            ...
            /// Default
            /// </summary>
            public const int Default = NativeMethods.SCE_MSSQL_DEFAULT;

            /// <summary>
            /// Comment style index.
            /// </summary>
            public const int Comment = NativeMethods.SCE_MSSQL_COMMENT;

            /// <summary>
            /// LineComment
            /// </summary>
            public const int LineComment = NativeMethods.SCE_MSSQL_LINE_COMMENT;

            /// <summary>
            /// Number style index.
            /// </summary>
            public const int Number = NativeMethods.SCE_MSSQL_NUMBER;

            /// <summary>
            /// String style index.
            /// </summary>
            public const int String = NativeMethods.SCE_MSSQL_STRING;

            /// <summary>
            /// Keywords index 6 
            /// </summary>
            public const int Operator = NativeMethods.SCE_MSSQL_OPERATOR;

            /// <summary>
            /// Identifier
            /// </summary>
            public const int Identifier = NativeMethods.SCE_MSSQL_IDENTIFIER;

            /// <summary>
            /// Variable
            /// </summary>
            public const int Variable = NativeMethods.SCE_MSSQL_VARIABLE;

            /// <summary>
            /// ColumnName
            /// </summary>
            public const int ColumnName = NativeMethods.SCE_MSSQL_COLUMN_NAME;


            /// <summary>
            /// Keywords index 0
            /// </summary>
            public const int Statement = NativeMethods.SCE_MSSQL_STATEMENT;

            /// <summary>
            /// keywords index 1
            /// </summary>
            public const int DataType = NativeMethods.SCE_MSSQL_DATATYPE;

            /// <summary>
            /// keywords index 2
            /// </summary>
            public const int Systable = NativeMethods.SCE_MSSQL_SYSTABLE;

            /// <summary>
            /// keywords index 3
            /// </summary>
            public const int GlobalVariable = NativeMethods.SCE_MSSQL_GLOBAL_VARIABLE;

            /// <summary>
            /// keywords index 4
            /// </summary>
            public const int Function = NativeMethods.SCE_MSSQL_FUNCTION;

            /// <summary>
            /// keywords index 5
            /// </summary>
            public const int Procedure = NativeMethods.SCE_MSSQL_STORED_PROCEDURE;

            /// <summary>
            /// DefaultPrefDatatype
            /// </summary>
            public const int DefaultPrefDatatype = NativeMethods.SCE_MSSQL_DEFAULT_PREF_DATATYPE;

            /// <summary>
            /// ColumnName2.
            /// </summary>
            public const int ColumnName2 = NativeMethods.SCE_MSSQL_COLUMN_NAME_2;
